...
export declare class BaseRawConnection {
    ...
    _parse(language: Language, query: string, outputFormat: OutputFormat, expectedCardinality: Cardinality, state: Options, capabilitiesFlags?: number, options?: QueryOptions): Promise<ParseResult>;
    protected _executeFlow(language: Language, query: string, args: QueryArgs, outputFormat: OutputFormat, expectedCardinality: Cardinality, state: Options, inCodec: ICodec, outCodec: ICodec, result: any[] | WriteBuffer, capabilitiesFlags?: number, options?: QueryOptions): Promise<errors.GelError[]>;
